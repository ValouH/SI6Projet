...
De : <input type="text" name="d1" class="tcal" value="" /> Vers: <input type="text" name="d2" class="tcal" value="" /> <input type="submit" value="Search"><a id="addd" href="javascript:Clickheretoprint()">Imprimer</a>
</form>

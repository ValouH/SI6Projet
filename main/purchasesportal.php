...
<table id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><a href="deletep.php?id=<?php echo $row['id']; ?>&invoice=<?php echo $_GET['iv']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['name'];?>"> Supprimer </a></td>
			</tr>
			<?php
				}
			?>
...
<a id="cccc" href="index.php" style="margin-right: 10px;">Retour</a><a id="cccc" href="javascript:Clickheretoprint()">Imprimer</a>

...
<a href="javascript:Clickheretoprint()" style="font-size:20px";>Print</a>|<a href="index.php" style="font-size:20px";>Précédent</a>
<?php
...
<div style="margin: 0 auto; padding: 20px; width: 700px; font-weight: normal;">
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;text-align:left;" width="100%">
		...
		<tbody>
				...
				?>
				<tr>
					<td colspan="5"><strong style="font-size: 12px; color: #222222;">Appels d'offres en espèces:</strong></td>
					<td colspan="2"><strong style="font-size: 12px; color: #222222;">
					<?php
...
<div style="text-align: right; margin-top: 13px;">Caissier : <?php echo $cashier ?></div>
</div>
</div>

...
<span>Nom : </span><input type="text" name="name" value="<?php echo $row['product_name']; ?>" /><br>
<span>Coût : </span><input type="text" name="cost" value="<?php echo $row['cost']; ?>" /><br>
<span>Prix : </span><input type="text" name="price" value="<?php echo $row['price']; ?>" /><br>
...
<span>Quantité : </span><input type="text" name="qty" value="<?php echo $row['qty']; ?>" /><br>
